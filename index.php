...
<header class="header">
 ...
 <div class="icons">
        ...
        <a href="hostels.html"> <div class="fas fa-hotel" id="hotels-btn"></div></a>
<!--dropdown-->
    <div class="dropdown">
      ...
      <div class="dropdown-content">
       <ul>
        ...
        <li tyle="list-style-type:none"> <a href="#"> LOGOUT</a></li>
        </ul>
        </div>
 </div>
</div>
...
<section class="features" id="features">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="feature1.html" class="btn" style="font-size: 18px;">read more</a>
        </div>
        <div class="box">
            <img src="image/feature-img-2.png" alt="">
            <h3>Book Hostel</h3>
            <p> Book the hostel for your upcoming journey of life</p>
            <a href="feature2.html" class="btn" style="font-size: 18px;">read more</a>
        </div>
...
<section class="products" id="products">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <button class="btn btn-primary" data-toggle="collapse" data-target="#content" style="font-size: 20px;">View More</button>
...
<section class="categories" id="categories">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <h3>Boy's Hostel</h3>
            <p></p>
            <a href="boyshostel.html" class="btn">visit now</a>
        </div>
        ...
        <div class="box">
            ...
            <h3>Girl's Hostel</h3>
            <p></p>
            <a href="girlshostel.html" class="btn">visit now</a>
        </div>
